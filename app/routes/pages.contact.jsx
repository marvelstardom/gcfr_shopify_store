  ...
  return (
    <div className="w-full mt-32">
      ...
      <section className="contact-img relative h-72 bg-cover bg-top flex items-center justify-center text-white rounded-none">
        <h1 className="relative text-6xl text-[#febc22] font-bold z-10">Contact Us</h1>
      </section>

      {/* Contact Section */}
      <section className="flex flex-col md:flex-row px-6 md:px-20 lg:pl-24 py-24 mt-6 gap-16 bg-white">
        {/* Map */}
        ...
        {/* Form */}
        <div className="w-full md:w-1/2 space-y-4 pr-20">
          <h2 className="text-4xl font-normal mt-4">Questions or Comments? Get in touch and we'll be glad to help!</h2>
          <form className="space-y-4 mt-8" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label className="block text-sm font-medium">Full Name</label>
              <input
                type="text"
                className="w-[600px] border rounded-lg px-4 py-2"
            ...
            <div>
              ...
              <textarea
                className="w-[600px] border rounded-lg px-4 py-2 h-32"
            ...
            <button
              type="submit"
              className="bg-black w-[600px] text-white px-6 py-2 rounded-lg hover:bg-gray-800 transition"
            >
            Submit
            </button>
        </form>
        ...
        <div className="pt-6 border-t text-sm text-gray-700 space-y-1">
            ...
            <div className="mt-5 flex gap-2">
                <div className='flex flex-col gap-1 border-r  w-1/2'>
